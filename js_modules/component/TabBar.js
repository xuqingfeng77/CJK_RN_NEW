        ...
        return(
            <TabNavigator
                ...
                <TabNavigator.Item
                    ...
                    onPress={() => this.setState({ selectedTab: 'search' })}>{<SearchFragment />}
                </TabNavigator.Item>
                <TabNavigator.Item
                    tabStyle={styles.tabStyle}
                    title={tabName[2]}
                    ...
                    onPress={() => this.setState({ selectedTab: 'cart' })}>{<CartFragment />}
                </TabNavigator.Item>
                <TabNavigator.Item
                    tabStyle={styles.tabStyle}
                    title={tabName[3]}
                    ...
                    onPress={() => this.setState({ selectedTab: 'personal' })}>{<MeFragment />}
                </TabNavigator.Item>
